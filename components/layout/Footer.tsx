        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-400 text-sm max-w-xs">
              Discover local businesses that need AI services. Find leads, analyze opportunities, and generate personalized outreach in minutes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Dashboard', 'All Leads', 'How It Works', 'Pricing'].map((item) => (
                <li key={item}>
